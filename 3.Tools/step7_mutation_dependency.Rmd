...
V7_ROC_mut_interaction=test_mut_AUC_V1(seedNumber=1,
                                   ...
                                   which_level = c('R1','R2'))
V7_ROC_mut_interaction[[2]]$whether_interaction=
  V7_ROC_mut_interaction[[2]]$Estimate<0 & V7_ROC_mut_interaction[[2]]$`Pr(>|t|)`<0.2
V7_ROC_mut_interaction[[2]]$interaction_withP=
  (V7_ROC_mut_interaction[[2]]$Estimate)*(-log10(V7_ROC_mut_interaction[[2]]$`Pr(>|t|)`))
roc(V7_ROC_mut_interaction[[2]]$Label,
    V7_ROC_mut_interaction[[2]]$Estimate )
```
...
KnownTarget_predictions$predicted_resistance_mutation=
  KnownTarget_predictions$mutation_interaction_P<0.1
...
```
<!-- identify the top most mutated variants and compute a mutation interaction analysis accordingly -->
```{r}
knitr::knit('/Users/sinhas8/Project_TrueTarget/Tools_github/3.Tools/Step0_Write_Functions.Rmd')
knitr::knit('/Users/sinhas8/Project_TrueTarget/Tools_github/3.Tools/Step0B_Data_and_Libraries.Rmd')
```
...
```{r}
all_bioactive_compounds=readxl::read_xlsx('/Users/sinhas8/Project_TrueTarget/Data/20220609-L1700-Bioactive-Compound-Library-I-96-well.xlsx', sheet = 2)
...
write.csv(all_bioactive_compounds_matched_only_mostfreqtargets, 
          '/Users/sinhas8/Project_TrueTarget/Data/drugs_targeting_most_freq_drugs.csv')
...
write.csv(all_bioactive_compounds_braf_inscreen, 
          '/Users/sinhas8/Project_TrueTarget/Data/braf_compounds_inscreen.csv')
```
<!-- We perfomred a manual annotation of BRAF binding selectivity and added to above "braf_compounds_inscreen.csv" file-->
```{r}
all_bioactive_compounds_braf_inscreen=read.csv('/Users/sinhas8/Project_TrueTarget/Data/braf_compounds_inscreen.csv')
...
ggsave(Figure4, filename = '/Users/sinhas8/Project_TrueTarget/Results/Figure4_v0.png',
       width = 14, height = 8)
ggsave(Figure4, filename = '/Users/sinhas8/Project_TrueTarget/Results/Figure4_v0.pdf',
       width = 14, height = 8)
```
