...
```
<!-- Exploratory Analysis Part 1: We hypothesize and tested whether the Drugs where the primary target is not expressed in most cell lines, whether the Primary Target score of Known Target very low. -->
```{r}
# <!-- Add BTK as target manually -->
# In our target annotation, the infromation that BTK is a target of Ibrutinib is missing. We are manually adding that
...
# <!-- Cell lines with the following matrices: crispr, drug-treamtent, expression, mutation-->
...
# <!-- To this end, we first identify cell lines with low primary target expression -->
