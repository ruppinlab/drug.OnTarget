...
```{r}
remove_not_expressed=CancerInhibitors_noTargets_withsigTargets$KnownTarget_meanCorr>3
launched=CancerInhibitors_noTargets_withsigTargets$phase=='Launched'
